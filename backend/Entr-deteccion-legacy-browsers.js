...
function InicioRoutineBegin(snapshot) {
  return async function () {
    ...
    InicioComponents.forEach( function(thisComponent) {
...
function bloque1RoutineBegin(snapshot) {
  return async function () {
    ...
    bloque1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function feedRoutineBegin(snapshot) {
  return async function () {
    ...
    feedComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inicio_2RoutineBegin(snapshot) {
  return async function () {
    ...
    inicio_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bloque2RoutineBegin(snapshot) {
  return async function () {
    ...
    bloque2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inicio_3RoutineBegin(snapshot) {
  return async function () {
    ...
    inicio_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bloque3RoutineBegin(snapshot) {
  return async function () {
    ...
    bloque3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function feed2RoutineBegin(snapshot) {
  return async function () {
    ...
    feed2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
